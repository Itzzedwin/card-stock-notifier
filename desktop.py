...
SITE_URL = "https://itzzedwin.github.io/card-stock-notifier/"
RAW_BASE = "https://raw.githubusercontent.com/Itzzedwin/card-stock-notifier/main"
ISSUES_URL = "https://github.com/Itzzedwin/card-stock-notifier/issues/new"
...
# Segoe UI doesn't exist off Windows; tk would silently fall back to a
# fixed-width default and the layout widths stop lining up.
_UI_FONT = {"win32": "Segoe UI", "darwin": "SF Pro Text"}.get(sys.platform, "DejaVu Sans")
_BUMP = 2 if sys.platform == "darwin" else 0  # macOS renders these a bit smaller

FONT_H = (_UI_FONT, 15 + _BUMP, "bold")
FONT_S = (_UI_FONT, 11 + _BUMP, "bold")
FONT_B = (_UI_FONT, 10 + _BUMP)
...
class SetupWizard(tk.Tk):
    ...
    def step_cloud(self):
        ...
        self.p("   2.  In the app, tap  +  and subscribe to the team's topic "
               "name. Ask whoever set this up if you don't have it.", 1)
        self.p("")
...
class FeedbackDialog(tk.Toplevel):
    """Bug report / feature request -> a GitHub issue."""
